...
var user="",sex="",power={send:true,times:0},loc="";
...
var wsServer = 'ws://solo-hanangjie-4.c9.io';
var wsServer2 = 'ws://localhost:8888';
var wsServer3 = 'ws://192.168.66.161:8888';
var ws ;
if(location.href.indexOf("192.168.66.161")!=-1){
...
function setup(mmm,ws){
	...
	if(power.send){
		...
		ws.onmessage = function(e) {
			...
			re.local.sex=re.local.sex=="girl"?"/images/girl.png":"/images/boy.png";
			$("#num").html("人："+re.ser.num);
			var html='<li>'+
					'<div class="ui-avatar-s">'+
					'<span style="background-image:url('+re.local.sex+')"></span>'+
					'  </div>'+
					' <div class="ui-list-info ui-border-t">'+
					'  <h4>'+re.local.name+'<label style="font-size:12px;color:#999999;padding-left:10px;">'+re.ser.time+'</label><label style="font-size:12px;color:#999999;padding-left:10px;">'+re.local.loc+'</label></h4>'+
					'  <p>'+re.local.cont+'</p>'+
					' </div>'+
					' </li>';
